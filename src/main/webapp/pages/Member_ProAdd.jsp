...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="m_right">
            <p></p>		
            <div class="mem_t fr">
            	<a href="${basePath}pages/Member_ProAdd.jsp">商品添加</a>
            </div>
            <form action="${basePath}addProduct" method="post" enctype="multipart/form-data">
       			<table>
       				<tr>
       					<td>一级分类</td>
...
<script type="text/javascript" src="${basePath}static/js/Member_ProAdd.js"></script>
</body>
</html>
