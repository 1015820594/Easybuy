...
<div class="i_bg bg_color">
	...
	<div class="m_content">
		...
		<div class="m_right">
			...
			<div class="mem_t">
            	商品列表
            	<a href="${basePath}pages/Member_ProAdd.jsp" class="fr">商品添加</a>
            </div>
            
            <table border="1" class="mem_tab" style=" width:870px; margin-top:10px;" cellspacing="0" cellpadding="0">
              <tr>
                <td class="th_bg1"  >商品名称</td>
                <td class="th_bg1"  >商品图片</td>
                <td class="th_bg1"  >库存</td>
                <td class="th_bg1"  >价格</td>
                <td class="th_bg1"  colspan="2">操作</td>
              </tr>
            </table>
        </div>
    </div>
...
<script type="text/javascript" src="${basePath }static/js/Member_Prolist.js"></script>
</body>
</html>
