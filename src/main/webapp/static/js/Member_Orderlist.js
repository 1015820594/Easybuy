	...
	$(function() {
		...
		function Successone(data) {
			...
			for (var i = 0; i < data.length; i++) {
				var order = data[i];
				html +='<table id="'+order.oid+'" border="1" class="mem_tab" style="width:930px; text-align:center; margin-top:20px;" cellspacing="0" cellpadding="0"><tbody><tr><td class="th_bg1" >用户名:'+order.userName+'</td><td class="th_bg1" >订单号:'+order.serialNumber+'</td><td class="th_bg1" >地址:'+order.userAddress+'</td> <td class="th_bg1" > ￥'+order.cost+'</td></tr>';
